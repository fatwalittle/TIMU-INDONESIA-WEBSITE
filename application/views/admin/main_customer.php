        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Main Customer</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">Main Customer</li>
                    </ol>
                    ...
                    <a href="<?= site_url('admin/main_customer/create') ?>" class="btn btn-outline-primary">CREATE</a>
                                ...
                                foreach ($customers as $customer) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <img src="<?= base_url('uploads/logos/' . $customer->logo_customer); ?>" alt="Logo" width="50" class="rounded-circle">
                                        </td>
                                        <td class="text-center"><?= $customer->created_at; ?></td>
                                        <td class="text-center"><?= $customer->updated_at; ?></td>
                                        <td class="text-center">
                                            <!-- Tombol Edit -->
                                            <a href="<?= site_url('admin/main_customer/edit/' . $customer->id); ?>" class="btn btn-outline-info btn-sm rounded-3">
                                                Edit
                                            </a>
                                            <!-- Tombol Hapus dengan SweetAlert -->
                                            <a href="javascript:void(0);" class="btn btn-outline-danger btn-sm rounded-3 delete-btn" data-id="<?= $customer->id; ?>">
                                                Delete
                                            </a>
                                        </td>
                                                ...
                                                button.addEventListener('click', function() {
                                                    ...
                                                    Swal.fire({
                                                        ...
                                                        if (result.isConfirmed) {
                                                            ...
                                                            window.location.href = '<?= site_url('admin/main_customer/delete/'); ?>' + customerId;
                                                        }
                                                    });
                                                });
                                            });
