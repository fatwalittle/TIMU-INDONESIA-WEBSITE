        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Edit Main Customer</h1>
                    ...
                    <div class="mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <?= form_open_multipart('admin/main_customer/update/' . $customer['id']) ?>

                                <!-- Nama Customer -->
                                <div class="mb-3">
                                    <label for="nama_customer" class="form-label">1. Nama Customer</label>
                                    <input type="text" class="form-control" id="nama_customer" name="nama_customer" value="<?= $customer['nama_customer'] ?>" autocomplete="off" autofocus required>
                                </div>

                                <!-- Logo Customer -->
                                <div class="mb-3">
                                    <label for="logo_customer" class="form-label">2. Logo Customer</label>
                                    <input type="file" class="form-control" id="logo_customer" name="logo_customer" accept=".jpg,.jpeg,.png">
                                    <small>Logo saat ini: <?= $customer['logo_customer'] ?></small>
                                    <input type="hidden" name="old_logo" value="<?= $customer['logo_customer'] ?>">
