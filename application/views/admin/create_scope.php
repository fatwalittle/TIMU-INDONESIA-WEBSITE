            ...
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="mt-5">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <?= form_open_multipart('admin/scope/store') ?>

                                <!-- Jenis Scope -->
                                <div class="mb-3">
                                    <label for="jenis_scope" class="form-label">1. Jenis Scope</label>
                                    <input type="text" class="form-control" id="jenis_scope" name="jenis_scope" value="<?= set_value('jenis_scope') ?>" autocomplete="off" autofocus required>
                                </div>

                                <!-- Penjelasan Scope -->
                                <div class="mb-3">
                                    <label for="penjelasan_scope" class="form-label">2. Penjelasan Scope</label>
                                    <textarea class="form-control" id="penjelasan_scope" name="penjelasan_scope" rows="5" autocomplete="off" required><?= set_value('penjelasan_scope') ?></textarea>
                                </div>

                                <!-- Gambar Scope -->
                                <div class="mb-3">
                                    <label for="logo_customer" class="form-label">3. Gambar</label>
                                    <input type="file" class="form-control" id="gambar_scope" name="gambar_scope" accept=".jpg,.jpeg,.png" autocomplete="off" required>
